...
export const cancelTeamInvite = (sender_id, receiver_id) => ({
...
export const cancelFriendRequest = (sender_id, receiver_id) => ({
...
export const updateAchievementLog = (user_id, achievement_name) => ({
...
export const checkAllMissionComplete = (user_id) => ({
...
export const createChallengeGroup = (
  user_id,
  group_name,
  start_date,
  fb_group
...
const cancelFriendRequestSagaAsync = async (sender_id, receiver_id) => {
  try {
...
const cancelTeamInviteSagaAsync = async (sender_id, receiver_id) => {
  try {
...
const getFriendRequestSentSagaAsync = async (user_id) => {
  try {
...
const getTeamInviteSentSagaAsync = async (user_id) => {
  try {
...
const checkAllMissionCompleteSagaAsync = async (user_id) => {
  try {
...
const updateAchievementLogSagaAsync = async (user_id, achievement_name) => {
  try {
...
const getAchievementLogSagaAsync = async (user_id) => {
  try {
...
const acceptTeamInviteSagaAsync = async (user_id, group_id, log_id) => {
  try {
...
const rejectTeamInviteSagaAsync = async (log_id) => {
  try {
...
const getTeamInviteSagaAsync = async (user_id) => {
  try {
...
const sendTeamInviteSagaAsync = async (user_id, to) => {
  try {
...
const getFriendsRankSagaAsync = async (user_id) => {
  try {
...
const deleteFriendSagaAsync = async (user_id, friend_email) => {
  try {
...
const rejectFriendSagaAsync = async (log_id) => {
  try {
...
const acceptFriendSagaAsync = async (user_id, sender_id, log_id) => {
  try {
...
const getFriendRequestSagaAsync = async (user_id) => {
  try {
...
const sendFriendRequestSagaAsync = async (user_id, to) => {
  try {
...
const getMaxFriendsSagaAsync = async (user_id) => {
  try {
...
const getFriendListSagaAsync = async (user_id) => {
  try {
...
const getRankSagaAsync = async (user_id, start_date) => {
  try {
...
const getLogWeightSagaAsync = async (user_id) => {
  try {
...
const getNumberOfTeamNotFullSagaAsync = async (fb_group) => {
  try {
...
const getLogWeightTeamSagaAsync = async (group_id) => {
  try {
...
const getIsReducedWeightSagaAsync = async (user_id) => {
  try {
...
const getIsReducedWaistSagaAsync = async (user_id) => {
  try {
...
const selectMemberEventLogSagaAsync = async (email) => {
  try {
...
const getDailyWeighChallengeSagaAsync = async (user_id) => {
  try {
...
const postDailyWeighChallengeSagaAsync = async (user_id, weight) => {
  try {
    ...
    console.log(" post apiResult", apiResult);
    return apiResult;
  } catch (error) {
    console.log("error :", error);
    return { error, messsage: error.message };
...
const assignGroupToMemberSagaAsync = async (user_id, start_date, fb_group) => {
  try {
...
const leaveTeamSagaAsync = async (user_id) => {
  try {
...
const getMembersAndRankSagaAsync = async (group_id, start_date) => {
  try {
...
const getGroupNameSagaAsync = async (group_id) => {
  try {
...
const getScoreOfTeamSagaAsync = async (group_id) => {
  try {
...
const getDailyTeamWeightBonusSagaAsync = async (user_id) => {
  try {
...
function* checkAllMissionCompleteSaga({ payload }) {
  ...
  try {
    const apiResult = yield call(checkAllMissionCompleteSagaAsync, user_id);
...
function* getAchievementLogSaga({ payload }) {
  const { user_id } = payload;
  try {
    const apiResult = yield call(getAchievementLogSagaAsync, user_id);
    if (apiResult.results.message === "success") {
      yield put({
...
function* acceptTeamInviteSaga({ payload }) {
  const { user_id, group_id, log_id } = payload;
  try {
...
function* updateAchievementLogSaga({ payload }) {
  const { user_id, achievement_name } = payload;
  try {
    const apiResult = yield call(
...
function* rejectTeamInviteSaga({ payload }) {
  ...
  try {
    const apiResult = yield call(rejectTeamInviteSagaAsync, log_id);
    if (apiResult.results.message === "success") {
      yield put({
...
function* getTeamInviteSaga({ payload }) {
  const { user_id } = payload;
  try {
    const apiResult = yield call(getTeamInviteSagaAsync, user_id);
    if (apiResult.results.message === "success") {
      yield put({
...
function* sendTeamInviteSaga({ payload }) {
  const { user_id, to } = payload;
  try {
    const apiResult = yield call(sendTeamInviteSagaAsync, user_id, to);
    if (
      apiResult.results.message === "success" ||
      apiResult.results.message === "team_invite_exists"
    ) {
      yield put({
...
function* getFriendsRankSaga({ payload }) {
  const { user_id } = payload;
  try {
    const apiResult = yield call(getFriendsRankSagaAsync, user_id);
    if (apiResult.results.message === "success") {
      yield put({
...
function* rejectFriendSaga({ payload }) {
  const { log_id } = payload;
  try {
    const apiResult = yield call(rejectFriendSagaAsync, log_id);
    if (apiResult.results.message === "success") {
      yield put({
...
function* getFriendRequestSentSaga({ payload }) {
  const { user_id } = payload;
  try {
    const apiResult = yield call(getFriendRequestSentSagaAsync, user_id);
    if (apiResult.results.message === "success") {
      yield put({
...
function* getTeamInviteSentSaga({ payload }) {
  const { user_id } = payload;
  try {
    const apiResult = yield call(getTeamInviteSentSagaAsync, user_id);
    if (apiResult.results.message === "success") {
      yield put({
...
function* deleteFriendSaga({ payload }) {
  const { user_id, friend_email } = payload;
  try {
    const apiResult = yield call(deleteFriendSagaAsync, user_id, friend_email);
    if (apiResult.results.message === "success") {
      yield put({
...
function* acceptFriendSaga({ payload }) {
  const { user_id, sender_id, log_id } = payload;
  try {
    const apiResult = yield call(
...
function* getFriendListSaga({ payload }) {
  const { user_id } = payload;
  try {
    const apiResult = yield call(getFriendListSagaAsync, user_id);
    if (apiResult.results.message === "success") {
      yield put({
...
function* getFriendRequestSaga({ payload }) {
  const { user_id } = payload;
  try {
    const apiResult = yield call(getFriendRequestSagaAsync, user_id);
    if (apiResult.results.message === "success") {
      yield put({
...
function* getMaxFriendsSaga({ payload }) {
  const { user_id } = payload;
  try {
    const apiResult = yield call(getMaxFriendsSagaAsync, user_id);
    if (apiResult.results.message === "success") {
      yield put({
...
function* getRankSaga({ payload }) {
  ...
  try {
    const apiResult = yield call(getRankSagaAsync, user_id, start_date);
    yield put({
...
function* getLogWeightSaga({ payload }) {
  const { user_id } = payload;
  try {
    const apiResult = yield call(getLogWeightSagaAsync, user_id);
    yield put({
...
function* getLogWeightTeamSaga({ payload }) {
  ...
  try {
    const apiResult = yield call(getLogWeightTeamSagaAsync, group_id);
    yield put({
...
function* getNumberOfTeamNotFullSaga({ payload }) {
  const { fb_group } = payload;
  try {
    const apiResult = yield call(getNumberOfTeamNotFullSagaAsync, fb_group);
    yield put({
...
function* getLeaderboardSaga() {
  try {
    const apiResult = yield call(getLeaderboardSagaAsync);
    yield put({
...
function* getChallengePeriodSaga() {
  try {
    const apiResult = yield call(getChallengePeriodSagaAsync);
    yield put({
...
function* selectMemberEventLogSaga({ payload }) {
  const { email } = payload;
  try {
    const apiResult = yield call(selectMemberEventLogSagaAsync, email);
    yield put({
...
function* sendFriendRequestSaga({ payload }) {
  const { user_id, to } = payload;
  try {
    const apiResult = yield call(sendFriendRequestSagaAsync, user_id, to);
    if (
      apiResult.results.message === "success" ||
      apiResult.results.message === "friend_request_exists"
    ) {
      yield put({
...
function* getIsReducedWeightSaga({ payload }) {
  const { user_id } = payload;
  try {
    const apiResult = yield call(getIsReducedWeightSagaAsync, user_id);
    yield put({
...
function* getIsReducedWaistSaga({ payload }) {
  const { user_id } = payload;
  try {
    const apiResult = yield call(getIsReducedWaistSagaAsync, user_id);
    yield put({
...
function* getDailyWeighChallengeSaga({ payload }) {
  const { user_id } = payload;
  try {
    const apiResult = yield call(getDailyWeighChallengeSagaAsync, user_id);
    yield put({
...
function* assignGroupToMemberSaga({ payload }) {
  const { user_id, start_date, fb_group } = payload;
  try {
    const apiResult = yield call(
...
function* createChallengeGroupSaga({ payload }) {
  const { user_id, group_name, start_date, fb_group } = payload;
  try {
    const apiResult = yield call(
...
function* leaveTeamSaga({ payload }) {
  const { user_id } = payload;
  try {
    const apiResult = yield call(leaveTeamSagaAsync, user_id);
    yield put({
...
function* getMembersAndRankSaga({ payload }) {
  const { group_id, start_date } = payload;
  try {
    const apiResult = yield call(
...
function* getGroupNameSaga({ payload }) {
  const { group_id } = payload;
  try {
    const apiResult = yield call(getGroupNameSagaAsync, group_id);
    yield put({
...
function* getScoreOfTeamSaga({ payload }) {
  const { group_id } = payload;
  try {
    const apiResult = yield call(getScoreOfTeamSagaAsync, group_id);
    yield put({
...
function* getDailyTeamWeightBonusSaga({ payload }) {
  const { user_id } = payload;
  try {
    const apiResult = yield call(getDailyTeamWeightBonusSagaAsync, user_id);
    yield put({
...
export function* watchPostDailyWeighChallenge() {
  yield takeEvery(
    types.POST_DAILY_WEIGH_CHALLENGE,
    postDailyWeighChallengeSaga
  );
}

export function* watchGetDailyTeamWeightBonus() {
  yield takeEvery(
    types.GET_DAILY_TEAM_WEIGHT_BONUS,
    getDailyTeamWeightBonusSaga
  );
}

export function* watchGetNumberOfTeamNotFull() {
  yield takeEvery(
    types.GET_NUMBER_OF_TEAM_NOT_FULL,
    getNumberOfTeamNotFullSaga
  );
}
...
export function* watchCheckAllMissionComplete() {
  yield takeEvery(
    types.CHECK_ALL_MISSION_COMPLETE,
    checkAllMissionCompleteSaga
  );
}
